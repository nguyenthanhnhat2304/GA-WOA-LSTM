...
[cite_start]_Highlights:_ For HPG, GA-WOA-LSTM reduced RMSE by 11.89% compared to the standalone WOA-LSTM[cite: 734]. [cite_start]For DPM, it reduced MAPE by 24.15% compared to GA-LSTM[cite: 736].
